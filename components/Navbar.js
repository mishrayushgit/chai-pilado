  ...
  return (
    <nav className='bg-gray-900 text-white flex h-14 items-center justify-between px-4'>
        ...
        <div className="relative">
          {session && <>
          <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-3" type="button" onClick={()=>setshowDropdown(!showDropdown)} onBlur={() => {
            setTimeout(() => {
