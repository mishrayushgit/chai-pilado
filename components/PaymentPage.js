...
<div className='cover object-cover w-full relative'>
    ...
    <div className='makePayment w-1/2 text-white p-5 bg-slate-900 rounded-lg'>
      ...
      <div className='flex gap-2 mt-8 flex-col justify-center'>
        ...
        <input onChange={handleChange} value ={paymentform.amount}  type="text" className='w-full p-3 rounded-lg bg-slate-800' placeholder='Enter the Amount'/>
      ...
      <button className='cursor-pointer p-3 rounded-lg bg-slate-800' onClick={()=>pay(20)}>Pay ₹20</button>
      <button className='cursor-pointer p-3 rounded-lg bg-slate-800' onClick={()=>pay(30)}>Pay ₹30</button>
      <button className='cursor-pointer p-3 rounded-lg bg-slate-800' onClick={()=>pay(40)}>Pay ₹40</button>
      </div>
    </div>
      </div>
    </div>
